...
const ioEventApi = {
  ...
  Text_Limit_Exeed(e) {
    virtualclass.view.createErrorMsg(virtualclass.lang.getString('Text_Limit_Exeed'), 'errorContainer', 'rightSubContainer', { className: 'Text_Limit_Exeed' });
  },

  Binary_Limit_Exeed(e) {
    virtualclass.view.createErrorMsg(virtualclass.lang.getString('Binary_Limit_Exeed'), 'errorContainer', 'rightSubContainer', { className: 'Binary_Limit_Exeed' });
  },

  Unauthenticated(e) {
    virtualclass.view.createErrorMsg(virtualclass.lang.getString('Unauthenticated'), 'errorContainer', 'rightSubContainer', { className: 'Unauthenticated' });
    virtualclass.vutil.stopConnection();
  },

  Multiple_login(e) {
    virtualclass.view.createErrorMsg(virtualclass.lang.getString('Multiple_login'), 'errorContainer', 'rightSubContainer', { className: 'Multiple_login' });
    virtualclass.vutil.stopConnection();
  },

  Max_rooms(e) {
    virtualclass.view.createErrorMsg(virtualclass.lang.getString('Max_rooms'), 'errorContainer', 'rightSubContainer', { className: 'Max_rooms' });
  },

  Max_users(e) {
    virtualclass.view.createErrorMsg(virtualclass.lang.getString('Max_users'), 'errorContainer', 'rightSubContainer', { className: 'Max_users' });
  },
