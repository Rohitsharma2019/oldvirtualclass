...
this["JST"]["dest_temp/templates/chat/stickycont.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    ...
    + "\"><span id=\"usertab_text\">  </span></a>  </li> ";
},"3":function(container,depth0,helpers,partials,data) {
    return " <li class=\"vmchat_bar_button congtooltip active\" id=\"user_list\" data-title=\""
    + container.escapeExpression((helpers.getString || (depth0 && depth0.getString) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),"userList",{"name":"getString","hash":{},"data":data}))
    + "\"><a class=\"inner_bt \"><span id=\"usertab_text\">  </span></a></li> ";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing, alias3=container.escapeExpression;
  ...
  return "<ul class=\"chatBarTab nav navbar-nav\"><li class=\"vmchat_bar_button\" id=\"techVideo\"><a class=\"inner_bt congtooltip\" data-title=\""
    ...
    + "\"><a id=\"appSettingCtrlAnchor\"><span class=\"setting-btn\"></span></a></li>  </ul>";
},"useData":true});
...
this["JST"]["dest_temp/templates/leftBar.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"virtualclassAppLeftPanel\" class=\"leftbar hideZoom\" data-surname=\""
    ...
    + "\"> "
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.hasControls : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + " <div id=\"virtualclassAppContainer\"><div id=\"dashboardContainer\" class=\"bootstrap\"></div><div id=\"virtualclassWhiteboard\" class=\"virtualclass whiteboard\" style=\"display:none;\"><div class=\"whiteboardContainer\"></div> "
    ...
    + " </div></div><div id=\"leftWrapperButton\"><div id=\"sidebarButton\"><span class=\"congtooltip sidebarButton\" data-title=\"Move Rightbar\"><i class=\"icon-sidebarButton cgIcon\"></i></span></div></div><div id=\"leftbarFooter\"><div id=\"stickybar\" class=\"maximize something-happend\"><div id=\"tabs\" class=\"tabs-bottom ui-tabs ui-widget ui-widget-content ui-corner-all\"><ul class=\"tabs ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all\" role=\"tablist\"></ul></div></div></div><a id=\"congrealogo\" href=\"https://www.congrea.com\" target=\"_blank\"><img src=\"https://cdn.congrea.net/resources/images/congrea_logo.svg\"></a></div>";
},"usePartial":true,"useData":true});
...
this["JST"]["dest_temp/templates/main.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = container.invokePartial(partials.precheck,depth0,{"name":"precheck","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    ...
    + " "
    + ((stack1 = container.invokePartial(partials.mobileWarning,depth0,{"name":"mobileWarning","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
...
this["JST"]["dest_temp/templates/rightBar.hbs"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"virtualclassAppRightPanel\" class=\"rightbar bootstrap chat_enabled\"><div id=\"userInfo\" class=\"showUserList\"><div id=\"stickycontainer\"></div> "
    ...
    + " <div class=\"footerCtr\" id=\"congFooterCtr\"><div class=\"vmchat_search\" id=\"congchatBarInput\"><input type=\"text\" id=\"congreaUserSearch\" class=\"search\" placeholder=\""
    ...
    + "\"></div></div></div></div><div id=\"fixedRight\"><div id=\"footerButtons\"> "
    + ((stack1 = container.invokePartial(partials.screenShareButtons,depth0,{"name":"screenShareButtons","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + " <div id=\"docShareNav\"></div></div> "
...
this["JST"]["dest_temp/templates/ssmainDiv.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return " "
    + ((stack1 = helpers.unless.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.recImg : depth0),{"name":"unless","hash":{},"fn":container.program(9, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + " ";
},"9":function(container,depth0,helpers,partials,data) {
