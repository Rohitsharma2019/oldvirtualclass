...
this["JST"]["dest_temp/templates/chat/stickycont.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<ul class=\"chatBarTab nav navbar-nav\"><li class=\"vmchat_bar_button\" id=\"techVideo\"><a class=\"inner_bt congtooltip\" data-title=\""
    ...
    + "\"><a class=\"inner_bt stdRaiseHand\"><span id=\"icHr\" data-action=\"enable\" class=\"icon-hr-enable\"></span></a></li><li id=\"appSettingCtrl\" class=\"congtooltip chatActive\" data-title =\""
    + alias3((helpers.getString || (depth0 && depth0.getString) || alias2).call(alias1,"setting",{"name":"getString","hash":{},"data":data}))
    + "\"><a id=\"appSettingCtrlAnchor\" class=\"inner_bt\"><span class=\"setting-btn\"></span></a></li>  </ul>";
},"useData":true});
...
this["JST"]["dest_temp/templates/footerBar.hbs"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"footerBar\"> "
    ...
    + " <div id=\"stickycontainer\"></div></div>";
},"usePartial":true,"useData":true});
...
this["JST"]["dest_temp/templates/rightBar.hbs"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"virtualclassAppRightPanel\" class=\"rightbar bootstrap chat_enabled\"><div id=\"userInfo\" class=\"showUserList\"> "
    ...
    + "\"></div></div></div></div><div id=\"docShareNav\"></div>  </div>";
},"usePartial":true,"useData":true});
...
this["JST"]["dest_temp/templates/whiteboard/toolbar.hbs"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"commandToolsWrapper"
    ...
    + "\" class=\"congtooltip\"></a><ul class=\"strkSizeList\"><li id=\"strk-1"
    + alias4(((helper = (helper = helpers.cn || (depth0 != null ? depth0.cn : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"cn","hash":{},"data":data}) : helper)))
